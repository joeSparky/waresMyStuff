...
public class MyLinkObjectTest {
	...
	protected void loadMoa() throws Exception {
		...
		try {
			...
			levelOne.add();
			parentObjectMustBeOne = Utilities.getLevel1();
		} catch (Exception e1) {
		...
		try {
			childObjectMustBeOne = Utilities.getLevel2();
		} catch (Exception e1) {
			fail(e1.getLocalizedMessage());
		}
		...
		try {
			parentObjectMustBePositive = Utilities.getLevel2();
		} catch (Exception e1) {
			fail(e1.getLocalizedMessage());
		}
		...
		try {
			childObjectMustBePositive = Utilities.getLevel3();
		} catch (Exception e1) {
			fail(e1.getLocalizedMessage());
		}
		...
		try {
			parentOfChildWithOnlyOneParent.add();
		} catch (Exception e) {
			fail(e.getLocalizedMessage());
		}
